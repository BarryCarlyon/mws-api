    ...
    return {
        ...
        Message: _.map(arr(data), (m) => ({
            ...
            Product: _.map(arr(m.Product), (product) => ({
                ...
                StandardProductID: _.map(arr(m.StandardProductID), (standardproductid) => ({
                ...
                Condition: _.map(arr(m.Condition), (condition) => ({
                ...
                DescriptionData: _.map(arr(m.DescriptionData), (descriptiondata) => ({
